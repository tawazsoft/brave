...
$(document).ready(function(){
  ...
  $('.slider').slick({
    ...
    slidesToShow: 1,
    slidesToScroll: 4,
    nextArrow: '<div class="slick-custom-arrow slick-custom-arrow-right"><img src="img/Play Button.png" alt="" class="play1"></div>',
    prevArrow: '<div class="slick-custom-arrow slick-custom-arrow-left">  <img src="img/Play Button2.png" alt="" srcset="" class="play2"></div>',
  });
...
$(document).ready(function(){
  ...
  $('.slider2').slick({
    ...
    slidesToShow: 2,
    slidesToScroll: 4,
    nextArrow: '<div class="slick-custom-arrow slick-custom-arrow-right"><img src="img/Next Activity Button.png" alt="" class="play1"></div>',
    prevArrow: false,
  });
